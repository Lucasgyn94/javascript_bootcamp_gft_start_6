...
console.log('Operação de subtração com código de produto: ' + codigoExato);
...
console.log(`Produto de ${multiplicador} x ${multiplicando} = ${produto}`);

let notaDoMercado = 50;
let pessoasParaDividir = 2;


console.log(`Operação de divisão: ${notaDoMercado} / ${pessoasParaDividir} = ${notaDoMercado / pessoasParaDividir}` );
